...
**Компоновщик** — это структурный паттерн проектирования, компонующий объекты для представления древовидной иерархии. Позволяет единообразно работать      
как с обычными так и составными объектами.
