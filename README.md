...
Другим пример будет написание предметов и их экзаменов. Представим интерфейс - *Предмет*. Реализуем наш интерфейс конкретными предметам: *Физика*, *Математика*, *Русский Язык*, ... . Каждый из предметов может сдаваться как в виде устного экзамена, так и пиьсменного. И снова для каждого из предметов нам нужно писать по два класса с нужной реализацей сдачи экзамена. Получим клубок взаимосвязанных классов.   
